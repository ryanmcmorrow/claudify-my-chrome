import { a as d, c as R, i as A, l as S, n as CODEX_MODELS, o as q, r as PROVIDERS, s as y, t as u } from "./jsxRuntime.module.js";
							...
							children: [
								/* @__PURE__ */ u("div", {
									...
									children: [/* @__PURE__ */ u("span", {
										...
										children: "Hanzi Managed"
									})]
								}),
								/* @__PURE__ */ u("p", {
									class: "provider-desc",
									style: { marginTop: "12px" },
									children: "Your browser is connected to Hanzi's managed AI service. Tasks you run in the sidepanel use your managed account."
								}),
								/* @__PURE__ */ u("button", {
...
function SkillsTab({ userSkills, builtInSkills, skillForm, setSkillForm, onAdd, onEdit, onRemove, formError }) {
	return /* @__PURE__ */ u("div", {
		...
		children: [
			/* @__PURE__ */ u("p", {
				class: "tab-desc",
				children: "Teach Hanzi how to navigate specific websites better"
			}),
			/* @__PURE__ */ u("button", {
				class: "btn btn-secondary",
