...
export function buildSystemPrompt(taskUrl) {
    ...
    const blocks = [
        {
            type: "text",
            text: `You are Claudify, a browsing sub-agent driving the user's own Chrome browser — with all their logins, cookies, and sessions already in place. A host agent (Claude Code, Cursor, Codex, etc.) has delegated a task to you. Your job is to complete that task autonomously using the browser tools below, and return a concise answer.
